...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  String _translateEarthquakePlace(String englishPlace) {
    ...
    text = text.replaceAll('China', 'چین');
    text = text.replaceAll('Pakistan', 'پاکستان');
